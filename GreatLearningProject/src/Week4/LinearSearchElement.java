...
public class LinearSearchElement {
    ...
    public void implementationOfLinearSearchElement() {
    	
    	System.out.println("Enter the number of element you want to have in the array.");
    ...
    public static void main(String[] args) {
    	...
    	LinearSearchElement linearSearchElement = new LinearSearchElement();
    	linearSearchElement.implementationOfLinearSearchElement();
    }
}
